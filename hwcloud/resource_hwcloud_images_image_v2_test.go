		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesImageV2Exists("hwcloud_images_image_v2.image_1", &image),
					resource.TestCheckResourceAttr(
						"hwcloud_images_image_v2.image_1", "name", "Rancher TerraformAccTest"),
					resource.TestCheckResourceAttr(
						"hwcloud_images_image_v2.image_1", "container_format", "bare"),
					resource.TestCheckResourceAttr(
						"hwcloud_images_image_v2.image_1", "disk_format", "qcow2"),
					resource.TestCheckResourceAttr(
						"hwcloud_images_image_v2.image_1", "schema", "/v2/schemas/image"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesImageV2Exists("hwcloud_images_image_v2.image_1", &image),
					resource.TestCheckResourceAttr(
						"hwcloud_images_image_v2.image_1", "name", "TerraformAccTest Rancher"),
				),
			},
		},
	})
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesImageV2Exists("hwcloud_images_image_v2.image_1", &image),
					testAccCheckImagesImageV2HasTag("hwcloud_images_image_v2.image_1", "foo"),
					testAccCheckImagesImageV2HasTag("hwcloud_images_image_v2.image_1", "bar"),
					testAccCheckImagesImageV2TagCount("hwcloud_images_image_v2.image_1", 2),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckImagesImageV2HasTag("hwcloud_images_image_v2.image_1", "foo"),
					testAccCheckImagesImageV2HasTag("hwcloud_images_image_v2.image_1", "bar"),
					testAccCheckImagesImageV2HasTag("hwcloud_images_image_v2.image_1", "baz"),
					testAccCheckImagesImageV2TagCount("hwcloud_images_image_v2.image_1", 3),
				),
			},
			resource.TestStep{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesImageV2Exists("hwcloud_images_image_v2.image_1", &image),
					resource.TestCheckResourceAttr(
						"hwcloud_images_image_v2.image_1", "visibility", "private"),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckImagesImageV2Exists("hwcloud_images_image_v2.image_1", &image),
					resource.TestCheckResourceAttr(
						"hwcloud_images_image_v2.image_1", "visibility", "public"),
				),
			},
		},
	})
...
func testAccCheckImagesImageV2Destroy(s *terraform.State) error {
	...
	if err != nil {
		return fmt.Errorf("Error creating HWCloud Image: %s", err)
	}

	for _, rs := range s.RootModule().Resources {
		if rs.Type != "hwcloud_images_image_v2" {
			continue
		}
...
var testAccImagesImageV2_basic = `
  resource "hwcloud_images_image_v2" "image_1" {
      ...
      image_source_url = "https://releases.rancher.com/os/latest/rancheros-hwcloud.img"
