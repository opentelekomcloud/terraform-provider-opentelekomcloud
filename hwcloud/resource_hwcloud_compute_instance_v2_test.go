		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeV2InstanceExists("hwcloud_compute_instance_v2.instance_1", &instance),
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeV2SecGroupExists(
						"hwcloud_compute_secgroup_v2.secgroup_1", &secgroup_1),
					testAccCheckComputeV2InstanceExists(
						"hwcloud_compute_instance_v2.instance_1", &instance_1),
				),
			},
		},
	})
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeV2SecGroupExists(
						"hwcloud_compute_secgroup_v2.secgroup_1", &secgroup_1),
					testAccCheckComputeV2SecGroupExists(
						"hwcloud_compute_secgroup_v2.secgroup_2", &secgroup_2),
					testAccCheckComputeV2InstanceExists(
						"hwcloud_compute_instance_v2.instance_1", &instance_1),
				),
			},
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeV2InstanceExists(
						"hwcloud_compute_instance_v2.instance_1", &instance1_1),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeV2InstanceExists(
						"hwcloud_compute_instance_v2.instance_1", &instance1_2),
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckBlockStorageV2VolumeExists(
						"hwcloud_blockstorage_volume_v2.volume_1", &volume),
				),
			},
		},
	})
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeV2InstanceExists(
						"hwcloud_compute_instance_v2.instance_1", &instance),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeV2InstanceExists("hwcloud_compute_instance_v2.instance_1", &instance),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "access_ip_v4", "192.168.1.100"),
				),
			},
		},
	})
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "all_metadata.foo", "bar"),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "all_metadata.abc", "def"),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "all_metadata.foo", "bar"),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "all_metadata.ghi", "jkl"),
				),
			},
		},
	})
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPtr(
						"hwcloud_compute_instance_v2.instance_1", "network.1.uuid", &network.ID),
				),
			},
		},
	})
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckNetworkingV2NetworkExists(
						"hwcloud_networking_network_v2.network_1", &network_1),
					testAccCheckNetworkingV2NetworkExists(
						"hwcloud_networking_network_v2.network_2", &network_2),
					testAccCheckNetworkingV2PortExists(
						"hwcloud_networking_port_v2.port_1", &port_1),
					testAccCheckNetworkingV2PortExists(
						"hwcloud_networking_port_v2.port_2", &port_2),
					testAccCheckNetworkingV2PortExists(
						"hwcloud_networking_port_v2.port_3", &port_3),
					testAccCheckNetworkingV2PortExists(
						"hwcloud_networking_port_v2.port_4", &port_4),
					resource.TestCheckResourceAttrPtr(
						"hwcloud_compute_instance_v2.instance_1", "network.1.uuid", &network_1.ID),
					resource.TestCheckResourceAttrPtr(
						"hwcloud_compute_instance_v2.instance_1", "network.2.uuid", &network_2.ID),
					resource.TestCheckResourceAttrPtr(
						"hwcloud_compute_instance_v2.instance_1", "network.3.uuid", &network_1.ID),
					resource.TestCheckResourceAttrPtr(
						"hwcloud_compute_instance_v2.instance_1", "network.4.uuid", &network_2.ID),
					resource.TestCheckResourceAttrPtr(
						"hwcloud_compute_instance_v2.instance_1", "network.5.uuid", &network_1.ID),
					resource.TestCheckResourceAttrPtr(
						"hwcloud_compute_instance_v2.instance_1", "network.6.uuid", &network_2.ID),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "network.1.name", "network_1"),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "network.2.name", "network_2"),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "network.3.name", "network_1"),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "network.4.name", "network_2"),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "network.5.name", "network_1"),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "network.6.name", "network_2"),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "network.7.name", "network_1"),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "network.8.name", "network_2"),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "network.1.fixed_ip_v4", "192.168.1.100"),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "network.2.fixed_ip_v4", "192.168.2.100"),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "network.3.fixed_ip_v4", "192.168.1.101"),
					resource.TestCheckResourceAttr(
						"hwcloud_compute_instance_v2.instance_1", "network.4.fixed_ip_v4", "192.168.2.101"),
					resource.TestCheckResourceAttrPtr(
						"hwcloud_compute_instance_v2.instance_1", "network.5.port", &port_1.ID),
					resource.TestCheckResourceAttrPtr(
						"hwcloud_compute_instance_v2.instance_1", "network.6.port", &port_2.ID),
					resource.TestCheckResourceAttrPtr(
						"hwcloud_compute_instance_v2.instance_1", "network.7.port", &port_3.ID),
					resource.TestCheckResourceAttrPtr(
						"hwcloud_compute_instance_v2.instance_1", "network.8.port", &port_4.ID),
				),
			},
		},
	})
...
func testAccCheckComputeV2InstanceDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "hwcloud_compute_instance_v2" {
			continue
		}
...
resource "hwcloud_compute_secgroup_v2" "secgroup_2" {
  name = "secgroup_2"
...
resource "hwcloud_compute_instance_v2" "instance_1" {
  ...
  block_device {
    uuid = "${hwcloud_blockstorage_volume_v2.volume_1.id}"
    source_type = "volume"
    destination_type = "volume"
    boot_index = 1
    delete_on_termination = true
...
resource "hwcloud_compute_instance_v2" "instance_1" {
  depends_on = ["hwcloud_networking_subnet_v2.subnet_1"]
...
resource "hwcloud_compute_instance_v2" "instance_1" {
  ...
  network {
    name = "${hwcloud_networking_network_v2.network_1.name}"
  }
...
resource "hwcloud_networking_network_v2" "network_2" {
  name = "network_2"
}

resource "hwcloud_networking_subnet_v2" "subnet_2" {
  name = "subnet_2"
  network_id = "${hwcloud_networking_network_v2.network_2.id}"
  cidr = "192.168.2.0/24"
  ip_version = 4
  enable_dhcp = true
  no_gateway = true
...
resource "hwcloud_networking_port_v2" "port_2" {
  name = "port_2"
  network_id = "${hwcloud_networking_network_v2.network_2.id}"
  admin_state_up = "true"

  fixed_ip {
    subnet_id = "${hwcloud_networking_subnet_v2.subnet_2.id}"
    ip_address = "192.168.2.103"
  }
}

resource "hwcloud_networking_port_v2" "port_3" {
  name = "port_3"
  network_id = "${hwcloud_networking_network_v2.network_1.id}"
  admin_state_up = "true"
...
resource "hwcloud_networking_port_v2" "port_4" {
  name = "port_4"
  network_id = "${hwcloud_networking_network_v2.network_2.id}"
  admin_state_up = "true"
...
resource "hwcloud_compute_instance_v2" "instance_1" {
  depends_on = [
    "hwcloud_networking_subnet_v2.subnet_1",
    "hwcloud_networking_subnet_v2.subnet_2",
    "hwcloud_networking_port_v2.port_1",
    "hwcloud_networking_port_v2.port_2",
  ]
  ...
  network {
    uuid = "${hwcloud_networking_network_v2.network_2.id}"
  ...
  network {
    port = "${hwcloud_networking_port_v2.port_2.id}"
  }

  network {
    port = "${hwcloud_networking_port_v2.port_3.id}"
  }

  network {
    port = "${hwcloud_networking_port_v2.port_4.id}"
  }
}
`, OS_NETWORK_ID)
