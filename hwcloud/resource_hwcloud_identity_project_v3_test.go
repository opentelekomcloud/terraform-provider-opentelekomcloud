			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"hwcloud_identity_project_v3.project_1", "name", projectName),
					resource.TestCheckResourceAttr(
						"hwcloud_identity_project_v3.project_1", "description", "A project"),
					resource.TestCheckResourceAttr(
						"hwcloud_identity_project_v3.project_1", "domain_id", "default"),
					resource.TestCheckResourceAttr(
						"hwcloud_identity_project_v3.project_1", "enabled", "true"),
					resource.TestCheckResourceAttr(
						"hwcloud_identity_project_v3.project_1", "is_domain", "false"),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"hwcloud_identity_project_v3.project_1", "name", projectName),
					resource.TestCheckResourceAttr(
						"hwcloud_identity_project_v3.project_1", "description", "Some project"),
					resource.TestCheckResourceAttr(
						"hwcloud_identity_project_v3.project_1", "domain_id", "default"),
					resource.TestCheckResourceAttr(
						"hwcloud_identity_project_v3.project_1", "enabled", "false"),
					resource.TestCheckResourceAttr(
						"hwcloud_identity_project_v3.project_1", "is_domain", "false"),
				),
			},
...
func testAccCheckIdentityV3ProjectDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "hwcloud_identity_project_v3" {
			continue
		}
