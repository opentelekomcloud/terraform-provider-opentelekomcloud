		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataLBName, "provisioning_status", "ACTIVE"),
					resource.TestCheckResourceAttr(dataLBName, "operating_status", "ONLINE"),
					resource.TestCheckResourceAttrSet(dataLBName, "project_id"),
				),
			},
			{
