...
func TestAccDataSourceSmnSubscriptions_basic(t *testing.T) {
	dataSource := "data.opentelekomcloud_smn_subscription_v2.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testDataSourceSmnSubscription_basic,
...
var testDataSourceSmnSubscription_basic = `
data "opentelekomcloud_smn_subscription_v2" "test" {
  subscription_urn = opentelekomcloud_smn_subscription_v2.subscription_1.id
}
