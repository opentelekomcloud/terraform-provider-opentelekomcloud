		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataName, "share_type", "WHOLE"),
					resource.TestCheckResourceAttrSet(dataName, "enterprise_project_id"),
					resource.TestCheckResourceAttrSet(dataName, "public_border_group"),
				),
			},
		},
	})
