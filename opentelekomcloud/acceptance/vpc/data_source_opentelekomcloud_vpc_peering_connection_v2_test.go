		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(dataSourceVpcPeeringNameID, "vpc_tenant_id"),
					resource.TestCheckResourceAttrSet(dataSourceVpcPeeringNameID, "created_at"),
					resource.TestCheckResourceAttrSet(dataSourceVpcPeeringNameID, "updated_at"),
