...
var (
	...
	OS_FGS_REQ_FILE            = os.Getenv("OS_FGS_REQ_FILE")
	OS_ENTERPRISE_PROJECT_ID   = os.Getenv("OS_ENTERPRISE_PROJECT_ID")
	OS_ENTERPRISE_PROJECT_NAME = os.Getenv("OS_ENTERPRISE_PROJECT_NAME")
)
...
func imageName() string {
	...
	return "Standard_Debian_13_amd64_bios_latest" // value valid for OTC PROD, both eu-de and eu-nl
}
