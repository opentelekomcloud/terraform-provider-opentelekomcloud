			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"opentelekomcloud_identity_user_v3.user_1", "name", userName),
					resource.TestCheckResourceAttr(
						"opentelekomcloud_identity_user_v3.user_1", "description", "A user"),
					resource.TestCheckResourceAttr(
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"opentelekomcloud_identity_user_v3.user_1", "name", userName),
					resource.TestCheckResourceAttr(
						"opentelekomcloud_identity_user_v3.user_1", "description", "Some user"),
					resource.TestCheckResourceAttr(
