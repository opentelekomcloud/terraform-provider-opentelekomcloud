...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			"opentelekomcloud_blockstorage_volume_v1":          resourceBlockStorageVolumeV1(),
			"opentelekomcloud_blockstorage_volume_v2":          resourceBlockStorageVolumeV2(),
			"opentelekomcloud_blockstorage_volume_attach_v2":   resourceBlockStorageVolumeAttachV2(),
			...
			"opentelekomcloud_lb_member_v1":                    resourceLBMemberV1(),
			"opentelekomcloud_lb_monitor_v1":                   resourceLBMonitorV1(),
			"opentelekomcloud_lb_pool_v1":                      resourceLBPoolV1(),
			"opentelekomcloud_lb_vip_v1":                       resourceLBVipV1(),
