...
func asyncWaitCssClusterV1Create(d *schema.ResourceData, config *cfg.Config, result interface{},
...
func asyncWaitCssClusterV1ExtendCluster(d *schema.ResourceData, config *cfg.Config, result interface{},
	client *golangsdk.ServiceClient, timeout time.Duration) (interface{}, error) {
