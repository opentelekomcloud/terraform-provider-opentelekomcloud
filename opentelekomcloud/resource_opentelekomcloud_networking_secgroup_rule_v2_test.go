			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_1", "remote_ip_prefix", "2001:558:fc00::/39"),
				),
			},
		},
	})
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNetworkingV2SecGroupExists(
						"opentelekomcloud_networking_secgroup_v2.secgroup_1", &secgroup_1),
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ah", &secgroup_rule_ah), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_dccp", &secgroup_rule_dccp), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_egp", &secgroup_rule_egp), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_esp", &secgroup_rule_esp), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_gre", &secgroup_rule_gre), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_igmp", &secgroup_rule_igmp), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ipv6_encap", &secgroup_rule_ipv6_encap), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ipv6_frag", &secgroup_rule_ipv6_frag), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ipv6_icmp", &secgroup_rule_ipv6_icmp), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ipv6_nonxt", &secgroup_rule_ipv6_nonxt), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ipv6_opts", &secgroup_rule_ipv6_opts), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ipv6_route", &secgroup_rule_ipv6_route), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ospf", &secgroup_rule_ospf), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_pgm", &secgroup_rule_pgm), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_rsvp", &secgroup_rule_rsvp), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_sctp", &secgroup_rule_sctp), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_udplite", &secgroup_rule_udplite), */
					/* testAccCheckNetworkingV2SecGroupRuleExists(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_vrrp", &secgroup_rule_vrrp), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ah", "protocol", "ah"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_dccp", "protocol", "dccp"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_egp", "protocol", "egp"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_esp", "protocol", "esp"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_gre", "protocol", "gre"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_igmp", "protocol", "igmp"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ipv6_encap", "protocol", "ipv6-encap"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ipv6_frag", "protocol", "ipv6-frag"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ipv6_icmp", "protocol", "ipv6-icmp"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ipv6_nonxt", "protocol", "ipv6-nonxt"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ipv6_opts", "protocol", "ipv6-opts"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ipv6_route", "protocol", "ipv6-route"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_ospf", "protocol", "ospf"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_pgm", "protocol", "pgm"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_rsvp", "protocol", "rsvp"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_sctp", "protocol", "sctp"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_udplite", "protocol", "udplite"), */
					/* resource.TestCheckResourceAttr(
					"opentelekomcloud_networking_secgroup_rule_v2.secgroup_rule_vrrp", "protocol", "vrrp"), */
				),
			},
		},
	})
