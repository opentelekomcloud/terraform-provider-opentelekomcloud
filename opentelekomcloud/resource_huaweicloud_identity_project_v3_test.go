			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"opentelekomcloud_identity_project_v3.project_1", "name", projectName),
					resource.TestCheckResourceAttr(
						"opentelekomcloud_identity_project_v3.project_1", "description", "A project"),
					resource.TestCheckResourceAttr(
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"opentelekomcloud_identity_project_v3.project_1", "name", projectName),
					resource.TestCheckResourceAttr(
						"opentelekomcloud_identity_project_v3.project_1", "description", "Some project"),
					resource.TestCheckResourceAttr(
						"opentelekomcloud_identity_project_v3.project_1", "domain_id", "default"),
					resource.TestCheckResourceAttr(
