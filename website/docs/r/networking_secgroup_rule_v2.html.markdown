---
layout: "openstack"
page_title: "HWCloud: hwcloud_networking_secgroup_rule_v2"
sidebar_current: "docs-openstack-resource-networking-secgroup-rule-v2"
description: |-
  Manages a V2 Neutron security group rule resource within HWCloud.
---
...
```
$ terraform import hwcloud_networking_secgroup_rule_v2.secgroup_rule_1 aeb68ee3-6e9d-4256-955c-9584a6212745
```
