---
layout: "openstack"
page_title: "HWCloud: hwcloud_networking_floatingip_v2"
sidebar_current: "docs-openstack-resource-networking-floatingip-v2"
description: |-
  Manages a V2 floating IP resource within HWCloud Neutron (networking).
---
...
```hcl
resource "hwcloud_networking_floatingip_v2" "floatip_1" {
  pool = "public"
}
```
...
```
$ terraform import hwcloud_networking_floatingip_v2.floatip_1 2c7f39f3-702b-48d1-940c-b50384177ee1
```
