...
func (client *ProviderClient) Request(method, url string, options *RequestOpts) (*http.Response, error) {
	...
	if options.RawBody != nil {
        ...
        fmt.Printf("[DEBUG] ...................zhongjun........ ces req method: %#v\n",  method)
        fmt.Printf("[DEBUG] ...................zhongjun........ ces req body: %s\n",  body)
        fmt.Printf("[DEBUG] ...................zhongjun........ ces req url: %#v\n",  url)
	...
	if err != nil {
                fmt.Printf("[DEBUG] ...................zhongjun........ ces error\n\n")
		return nil, err
	}

	fmt.Printf("[DEBUG] ...................zhongjun........ ces resp: %#v\n\n",  resp)
	fmt.Printf("[DEBUG] ...................zhongjun........ ces resp body: %#v\n\n",  resp.Body)
	...
	for _, code := range options.OkCodes {
                fmt.Printf("[DEBUG] ...................zhongjun........ ces code=%s \n resp.StatusCode=%s\n\n", code, resp.StatusCode)
		if resp.StatusCode == code {
                        fmt.Printf("[DEBUG] ...................zhongjun.......ok = true \n\n ")
			ok = true
			break
		}
	}

        fmt.Printf("[DEBUG] ...................zhongjun........ ces respErr beginnnnnnnnnnn\n\n")
	if !ok {
		...
		respErr := ErrUnexpectedResponseCode{
			...
			Body:     body,
                ...
                fmt.Printf("[DEBUG] ...................zhongjun........ ces respErr: %#v\n\n",  respErr)
                fmt.Printf("[DEBUG] ...................zhongjun........ ces respErr: %#v\n\n",  )
		...
		case http.StatusServiceUnavailable:
			...
			if error503er, ok := errType.(Err503er); ok {
                ...
                fmt.Printf("[DEBUG] ...................zhongjun........ ces err: %#v\n\n",  err)
                fmt.Printf("[DEBUG] ...................zhongjun........ ces22222222 respErr: %#v\n\n",  respErr)
		if err == nil {
			err = respErr
		}
        ...
        fmt.Printf("[DEBUG] ...................zhongjun........ return 0000 options: %#v\n\n",  options)
	// Parse the response body as JSON, if requested to do so.
	if options.JSONResponse != nil {
		defer resp.Body.Close()
                fmt.Printf("[DEBUG] ...................zhongjun........ return 0000 options.JSONResponse: %#v\n\n",  options.JSONResponse)
		if err := json.NewDecoder(resp.Body).Decode(options.JSONResponse); err != nil {
                        fmt.Printf("[DEBUG] ...................zhongjun........ return 0000 err: %#v\n\n",  err)
			return nil, err
		}
	}
        fmt.Printf("[DEBUG] ...................zhongjun........ return resp: %#v\n\n",  resp)
	return resp, nil
}
