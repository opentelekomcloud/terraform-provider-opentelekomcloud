...
func Create(client *gophercloud.ServiceClient, server_id string, opts CreateOptsBuilder) (r CreateResult) {
...
func Get(client *gophercloud.ServiceClient, server_id string) (r GetResult) {
...
func Delete(client *gophercloud.ServiceClient, server_id string) (r DeleteResult) {
