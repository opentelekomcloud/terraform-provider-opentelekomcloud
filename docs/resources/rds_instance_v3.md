...
* `param_group_id` **DEPRECATED** - (Optional) Specifies the parameter group ID. Changing this parameter will create a new resource.

* `configuration_template_id` - (Optional) Specifies the parameter template ID. Changing this parameter will create a new resource.
