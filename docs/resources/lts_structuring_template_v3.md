...
page_title: "OpenTelekomCloud: opentelekomcloud_lts_structuring_template_v3"
sidebar_current: "docs-opentelekomcloud-resource-lts-structuring-template-v3"
description: |-
  Manages a LTS Structuring configuration within T-Cloud Public (former OpenTelekomCloud).
---
...
```bash
$ terraform import opentelekomcloud_lts_structuring_template_v3.test <log_group_id>/<log_stream_id>
```
