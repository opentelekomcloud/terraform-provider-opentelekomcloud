...
page_title: "OpenTelekomCloud: opentelekomcloud_er_flow_logs_v3"
sidebar_current: "docs-opentelekomcloud-datasource-er-flow-logs-v3"
description: |-
  Get the ER instances flow logs info from OpenTelekomCloud
---


# opentelekomcloud_er_flow_logs_v3
...
* `region` - Region where the flow logs are located.
